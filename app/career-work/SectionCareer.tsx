...
const SectionCareer:React.FC<Props> = ({content,form}) => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#0693e3] to-[#FFFFFF]" id="section7">
       <Head>
        <title>My page title</title>
        <meta property="og:title" content="My page title" key="title" />
      </Head>
       <BasicModal modalOpen={modalOpen} setModalOpen={setModalOpen} handleClose={handleClose} form={form}/>
      <div className="md:container mx-auto px-4 pb-8">
        <div className="flex flex-col items-center ">
          <div className="py-8 w-full flex flex-col items-center">
            <h1
              className="sm:text-[40px] text-3xl font-bold text-white mt-8"
              data-aos="fade-left"
            >
             ตำแหน่งงาน
            </h1>
            <div
              className="border-4 mt-2 rounded-full w-[70px] h-[7px] border-white"
            ></div>
          </div>
          <h3 className="mb-8 text-white">เรามีตำแหน่งงานที่เปิดรับมากมาย…</h3>
            ...
            >
              ...
              <AccordionDetails>
                ...
                <div className="flex justify-center my-4">
                  <button className="py-2 px-12 text-white bg-gradient-to-b from-[#1f90cf] to-[#1e499a] rounded-[100px] cursor-pointer" onClick={() => setModalOpen(true)}>
                    สมัครงาน
                  </button>
                </div>
              </AccordionDetails>
